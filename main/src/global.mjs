...
var global = {
  ...
  publishToTelegram: function(obj, chname = "arvandguarantee_shop") {
    return new Promise(function(resolve, reject) {
      // obj.message += "\n\n\n" + "در حال پرداخت:" + "\n" + "@arvand_admin_channel" + "\n" + ""
  ...
  submitAction: function(obj) {
    return new Promise(function(resolve, reject) {
      Action.create(obj).then((res) => {
        // console.log('submit action:',obj);
        resolve(res);
      }).catch(err => {
        // console.log('error submit action:',obj);
      ...
      let options = {
        ...
        body: {
          "notification": {
            "title": title,
            "body": body,
            "click_action": "https://ap.shansebartar.com",
            "icon": "https://ap.shansebartar.com/assets/img/favicon-96x96.png"
          },
          "priority": "high",
          "to": "/topics/all"
        },
        headers: {
          ...
          "Authorization": "key=AAAAxylg-D4:APA91bHlBi_N-sw9fuAtcavkucx_BKwiiXG1bFprt9ChEFN1AEZFgdyesADZnWMu1dLCR6TDA_W1JeNOxFGCrxKDKC679XrXLKkuHcMUrE3vKOvuVLT4pBJvNNQupSufO0aY9a4eGz2O"
        },
        json: true // Automatically stringifies the body to JSON
      };
