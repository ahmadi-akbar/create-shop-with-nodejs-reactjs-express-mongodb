...
router.get('/', (req, res, next) => {
    ...
    // });
  res.render('index', {
    title: seo['addNewPost']['title'][req.headers.lan],
    description: seo['addNewPost']['description'][req.headers.lan],
    image: seo['addNewPost']['image'][req.headers.lan],
    url: seo['addNewPost']['url'][req.headers.lan],
    width: '512',
    height: '512',
    name: seo['addNewPost']['name'][req.headers.lan],
    lng: req.headers.lan,
    list: [],
    categories: []
  });
