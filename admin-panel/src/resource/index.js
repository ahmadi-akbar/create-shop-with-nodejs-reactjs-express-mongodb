...
const resources = { Attributes,Action,Category,Configuration,PrivateConfiguration,Customer,MainDashboard,Media,Order,OrderCart,Post,Product,Settings,Sms,Transaction ,User};
