...
import {List, PrintOrder, PrintPack, SimpleForm,OrderPaymentStatus,OrderStatus} from '@/components';
        ...
        <Show actions={<PostShowActions/>} {...props}>
            ...
            <SimpleShowLayout>
                ...
                {state == 'start' && ([
                    ...
                    <TextField source="customer_data.lastName" label={'نام خانوادگی'}/>,
                    <TextField source="customer_data.internationalCode" label={'کد ملی'}/>
                    ,
                    <TextField source="customer.phoneNumber" label={'شماره تماس مشتری'}/>,
                    <TextField source="customer_data.phoneNumber" label={'شماره تماس مشتری'}/>
                    ...
                    ,
                    <TextField source="billingAddress.PhoneNumber" label={'شماره تماس ارسال'}/>
                    ,
                    ...
                    ,
                    <TextField source="customer_data.phoneNumber" label={'شماره موبایل مشتری'}/>
                    ,
                    <TextField source="deliveryDay.description" label={'توضیحات ارسال'}/>
                    ,
                            ...
                            <SimpleList
                                ...
                                primaryText={record => {
                                    if (record && record.amount)
                                        return (record.amount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + ' تومان')
                                    else
                                        return '';
